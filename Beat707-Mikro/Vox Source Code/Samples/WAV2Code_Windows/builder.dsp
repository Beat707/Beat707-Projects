...
# ADD CPP /nologo /G6 /MT /W3 /GX /O2 /Ob2 /I "..\..\common" /I ".\source" /D "WIN32" /D "_WINDOWS" /D WINDOWS=1 /D "_CONSOLE" /D "_MBCS" /D "__WINDOWS_DS__" /D "__LITTLE_ENDIAN__" /Fo"Output/" /Fd"Output/" /FD /GA -O3 -Qxi -Qip /c
...
# ADD LINK32 oldnames.lib kernel32.lib user32.lib gdi32.lib winspool.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib comdlg32.lib msvcrt.lib /nologo /subsystem:console /pdb:none /machine:I386 /nodefaultlib:"libcmt.lib" /out:"WWav2C.exe" /libpath:"..\Common"
